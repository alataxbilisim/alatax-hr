...
export const operationalModuleGroups: ModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/attendance/shifts', labelKey: 'nav.timesheetShifts', permission: { module: 'timesheet', page: 'shifts' } },
      { path: '/attendance/shift-assignments', labelKey: 'nav.timesheetShiftAssign', permission: { module: 'timesheet', page: 'shifts' } },
      { path: '/attendance/reports', labelKey: 'nav.timesheetReports', permission: { module: 'timesheet', page: 'attendance' } },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/reports/schedules', labelKey: 'nav.reportSchedules', permission: { module: 'reports', page: 'schedules' } },
      { path: '/dashboards', labelKey: 'nav.dashboards', permission: { module: 'reports', page: 'dashboards' } },
    ],
  },
];
...
export const pinnedModuleGroups: ModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/settings/registry', labelKey: 'studio.settingsRegistry', permission: { module: 'settings', page: 'values' }, group: 'company' },
