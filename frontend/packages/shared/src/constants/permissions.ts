...
export function getPermissionFromPath(path: string): { module: string; page: string } | null {
  const pathMappings: Record<string, { module: string; page: string }> = {
    ...
    '/organization/branches': { module: 'management', page: 'branches' },
    '/organization/departments': { module: 'employees', page: 'departments' },
    '/organization/positions': { module: 'employees', page: 'positions' },
    '/organization/chart': { module: 'employees', page: 'organization' },
    '/audit-logs': { module: 'management', page: 'audit_logs' },
    '/settings': { module: 'management', page: 'settings' },
    '/settings/registry': { module: 'settings', page: 'values' },
    '/settings/report-privacy': { module: 'management', page: 'settings' },
    '/settings/custom-fields': { module: 'management', page: 'custom_fields' },
    '/settings/forms': { module: 'management', page: 'forms' },
    '/settings/workflows': { module: 'management', page: 'workflows' },
    '/settings/notification-templates': { module: 'management', page: 'notifications' },
    '/webhooks': { module: 'management', page: 'webhooks' },
    '/lookups': { module: 'management', page: 'lookups' },
    '/kvkk': { module: 'management', page: 'kvkk' },
    ...
    '/recruitment/cv-pool': { module: 'recruitment', page: 'cv_pool' },
    '/recruitment/interviews': { module: 'recruitment', page: 'applications' },
    '/recruitment/reports': { module: 'recruitment', page: 'applications' },
    '/recruitment/custom-fields': { module: 'recruitment', page: 'custom_fields' },
    '/pdks': { module: 'timesheet', page: 'attendance' },
    '/pdks/reports': { module: 'timesheet', page: 'attendance' },
    '/pdks/shifts': { module: 'timesheet', page: 'shifts' },
    '/pdks/shift-assignments': { module: 'timesheet', page: 'shifts' },
    '/pdks/kiosk': { module: 'timesheet', page: 'kiosk' },
    '/leaves': { module: 'leaves', page: 'requests' },
    '/leaves/types': { module: 'leaves', page: 'types' },
    '/leaves/balances': { module: 'leaves', page: 'balances' },
    '/leaves/calendar': { module: 'leaves', page: 'calendar' },
    '/leaves/holidays': { module: 'leaves', page: 'holidays' },
    '/leaves/policies': { module: 'leaves', page: 'accrual_policies' },
    '/leaves/reports': { module: 'leaves', page: 'requests' },
    '/leaves/custom-fields': { module: 'leaves', page: 'custom_fields' },
    '/payroll/payslips': { module: 'payroll', page: 'payslips' },
    '/payroll/expenses': { module: 'expenses', page: 'claims' },
    '/payroll/expenses/all': { module: 'expenses', page: 'claims' },
    '/payroll/expenses/categories': { module: 'expenses', page: 'categories' },
    '/payroll/salary-bands': { module: 'employees', page: 'salary' },
    '/payroll/salary-reviews': { module: 'employees', page: 'salary' },
    '/documents': { module: 'documents', page: 'list' },
    '/documents/categories': { module: 'documents', page: 'categories' },
    '/documents/reports': { module: 'documents', page: 'reports' },
    ...
    '/communication/announcements': { module: 'announcements', page: 'list' },
    '/communication/surveys': { module: 'surveys', page: 'list' },
    '/analytics': { module: 'analytics', page: 'reports' },
    '/dashboards': { module: 'reports', page: 'dashboards' },
    '/reports': { module: 'reports', page: 'definitions' },
    '/reports/measures': { module: 'reports', page: 'measures' },
    '/reports/schedules': { module: 'reports', page: 'schedules' },

    // —— Eski yollar (alias; legacyRedirects ile aynı yetki) ——
    ...
    '/employees/salary-bands': { module: 'employees', page: 'salary' },
    '/employees/salary-reviews': { module: 'employees', page: 'salary' },
    '/attendance': { module: 'timesheet', page: 'attendance' },
    '/attendance/shifts': { module: 'timesheet', page: 'shifts' },
    '/attendance/shift-assignments': { module: 'timesheet', page: 'shifts' },
    '/attendance/reports': { module: 'timesheet', page: 'attendance' },
    '/attendance/kiosk': { module: 'timesheet', page: 'kiosk' },
    '/payslips': { module: 'payroll', page: 'payslips' },
    '/expenses': { module: 'expenses', page: 'claims' },
    '/expenses/all': { module: 'expenses', page: 'claims' },
    '/expenses/categories': { module: 'expenses', page: 'categories' },
    '/announcements': { module: 'announcements', page: 'list' },
