...
class EmployeeDashboardController extends Controller
{
    ...
    public function show(int $id): JsonResponse
    {
        ...
        $dashboard = EmployeeDashboard::where('company_id', (\App\Support\CompanyContext::id() ?? $user->home_company_id))
            ->accessibleBy($user->id)
            ->findOrFail($id);
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $dashboard = EmployeeDashboard::create([
            'company_id' => (\App\Support\CompanyContext::id() ?? $user->home_company_id),
            'user_id' => $user->id,
            'name' => $validated['name'],
    ...
    public function getWidgetData(Request $request): JsonResponse
    {
        ...
        $query = Employee::where('company_id', (\App\Support\CompanyContext::id() ?? $user->home_company_id));
