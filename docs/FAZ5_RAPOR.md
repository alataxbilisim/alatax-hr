...
## D1e � Payla��m v2 + �effaf alan gizleme + eri�im denetimi + hassasiyet guard

**Tarih:** 2026-07-29  
**Commit:** feat(faz5): D1e payla��m v2 + �effaf alan gizleme + eri�im denetimi + hassasiyet guard

### Payla��m matrisi

| Seviye | �al��t�r/filtre/export | Tan�m d�zenle | Sil | Payla��m | Sahiplik devri |
|--------|------------------------|---------------|-----|----------|----------------|
| viewer | evet | hay�r | hay�r | hay�r | hay�r |
| editor | evet | evet | hay�r | hay�r | hay�r |
| owner | evet | evet | evet | evet | evet (+ transfer yetkisi) |

Hedef: kullan�c� / rol / departman. Klas�r payla��m� yok. Offboarding hook yok (DUR). Anonim/public yok.

### hidden_fields

meta.hidden_fields: [{key,label,reason}] � field_permission | sensitivity | dataset_scope. UI �erit + export notu.

### Access log

report_access_logs; filtre de�eri ham yaz�lmaz (hash); append-only; afterResponse; 12 ay + purge komutu.

### Hassasiyet + min h�cre

personal / special / anonymous_source / normal. Min h�cre e�ik 5. Alt/genel toplam: mask_when_any_leaf_masked.
...
**KULLANICI G�RSEL KONTROL� BEKL�YOR (bor�)**
